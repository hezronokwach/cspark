export const services = [
  {
    ...
    intro: [
      ...
      'From integrated urban and rural development plans to marine spatial planning across Lake Victoria and the Indian Ocean, our work bridges the gap between policy and practical implementation.',
    ],
    focusAreas: [
      'Integrated Strategic Urban Development Plans (ISUDPs) & Local Economic Development Plans (LEDPs)',
      'Rural development spatial frameworks across counties (Kisii, Siaya, Makueni)',
      'Marine spatial planning for Lake Victoria Basin & Indian Ocean coastal zones',
      'Participatory land governance under the Community Land Act & pastoralist land rights',
      'Innovative land tenure models (communal land trusts & land reorganisation)',
      'Technical support and capacity training for Urban Management Boards',
      'Municipal revenue research through land value capture and development charges',
    ],
    whyUs: [
  ...
  },
  {
    ...
    intro: [
      ...
      'CSPARK partners with informal workers across Kenyan cities to generate the data and evidence needed for inclusive urban markets and secure trading spaces.',
    ],
    focusAreas: [
      'Participatory enumeration of street traders across towns (Nakuru, Eldoret, Wote, Nairobi, Mombasa, Kisumu)',
      'Data collection on trade types, locations and operating patterns',
      'Technical support for participatory planning of urban markets',
      'Evidence briefs for county-level policies on secure trading spaces',
      'Linkages between enumeration results and municipal market infrastructure decisions',
    ],
    whyUs: [
  ...
  },
  {
    ...
    intro: [
      ...
      'CSPARK researches how people actually access, build and co-produce urban services across counties, and turns that knowledge into actionable frameworks.',
    ],
    focusAreas: [
      'Participatory solid waste management frameworks in urban neighbourhoods (Wote, Nairobi, Kisumu)',
      'Urban mobility and public transport integration research (Nairobi, Kisumu, Mombasa, Wote)',
      'County Green Energy Plans and clean energy transition strategies (Kisumu, Uasin Gishu, Mombasa, Makueni)',
      'Research on informal co-production of urban services (water extensions & energy access)',
      'Policy frameworks linking informal and formal transport modes in county spatial planning',
    ],
    whyUs: [
